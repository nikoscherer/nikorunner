...
public class NEWPathEditor {
    ...
    public static void init(Stage primaryStage, File pathFile)  {
        ...
        // sideMenu.getStyleClass().addAll("editing");
        ...
        sideMenu.getChildren().addAll(sideMenuBar);
