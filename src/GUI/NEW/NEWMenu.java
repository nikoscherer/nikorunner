...
import GUI.NEWPathEditor;
import GUI.PathEditor;
...
public class NEWMenu {
    ...
    public static void init(Stage primaryStage) {
        ...
        HBox menuBar = NEWWindowBar.createMenu(window);
        ...
        menu.getStylesheets().addAll("GUI/NEW/NEWMenu.css");
    ...
    static VBox createPath(File pathFile) {
        ...
        root.setPrefSize(nodeWidth, 125);
        ...
        pathOpen.setPrefSize(nodeWidth, 125 - 20);
        ...
        pathOpen.setOnAction(e -> {
            NEWPathEditor.init(window, new File(Constants.pathDir + pathName.getText().replace(" ", "_") + ".json"));
